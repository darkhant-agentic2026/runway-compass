...
from coach.api.deps import CurrentUser, Users
...
async def get_me(principal: CurrentUser, users: Users) -> MeResponse:
    """The verified principal's profile, preferences, and plan limits.
...
async def patch_prefs(
    patch: GlobalPrefsPatch, principal: CurrentUser, users: Users
) -> MeResponse:
